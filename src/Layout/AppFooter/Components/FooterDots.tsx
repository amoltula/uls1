                ...
                <div>
                  <div className="card no-shadow widget-chart widget-chart2 text-start p-0 m-1">
                    <div className="widget-chat-wrapper-outer">
                      ...
                      <div className="widget-chart-wrapper widget-chart-wrapper-lg opacity-10 m-0" style={{ minHeight: '100px' }}>
                      ...
                      <div className="widget-chart-wrapper widget-chart-wrapper-lg opacity-10 m-0" style={{ minHeight: '100px' }}>
                        <ResponsiveContainer width="100%" height="100%" minHeight={100}>
                          <AreaChart data={data55}
                            ...
                            <Area type="monotoneX" dataKey="uv" stroke="#d92550" strokeWidth="4"
                              fill="#d92550" fillOpacity=".1"/>
                          </AreaChart>
                        </ResponsiveContainer>
                      </div>
                    </div>
