...
class ListBoxes extends Component {
  ...
  renderAuthorItem(profile) {
    ...
    const trendColor = profile.trend === 'down' ? 'text-danger' : profile.trend === 'up' ? 'text-success' : 'text-warning';
    const TrendIcon = profile.trend === 'down' ? faAngleDown : profile.trend === 'up' ? faAngleUp : faDotCircle;
          ...
          <div className="widget-content-wrapper">
            ...
            <div className="widget-content-right">
              <div className="font-size-xlg text-muted">
                ...
                <CountUp start={0} end={profile.earnings} separator="" decimals={0} decimal="." prefix="" duration="10"/>
                  ...
                  <Card className="card-shadow-primary card-border mb-3">
                    ...
                    <div className="p-3">
                      ...
                      <ListGroup className="rm-list-borders" flush>
                        {this.profiles.filter(p => [4, 2, 3, 8, 9].includes(p.id)).map(profile => this.renderAuthorItem(profile))}
                      </ListGroup>
                    </div>
                    <CardFooter className="text-center d-block">
