...
class ListGroupExampleAdvanced extends Component {
  ...
  renderProfileListItem(profile, showButtons = true, showBadge = true) {
        ...
        <div className="widget-content p-0">
          <div className="widget-content-wrapper">
            ...
            <div className="widget-content-left">
              ...
              {profile.subtitle && (
                <div className="widget-subheading">{profile.subtitle}</div>
              )}
            </div>
            <div className="widget-content-right">
              ...
              {showBadge && profile.badge && (
                <div className="badge bg-danger">{profile.badge}</div>
              )}
              {!showButtons && !showBadge && profile.id === 4 && (
              ...
              {!showButtons && !showBadge && profile.id === 5 && (
                <div className="ms-auto badge rounded-pill bg-warning">
                  {profile.badge}
                </div>
              )}
              {!showButtons && !showBadge && profile.id === 3 && (
  ...
  render() {
    // Get specific profiles for different sections
    const profile1 = this.profiles.find(p => p.name === "Alina Mcloughlin");
    const profile2 = this.profiles.find(p => p.name === "Ruben Tillman");
    const profile3 = this.profiles.find(p => p.name === "Vinnie Wagstaff");
    const profile4 = this.profiles.find(p => p.name === "Ella-Rose Henry");
    const profile5 = this.profiles.find(p => p.name === "Eliot Huber");
    
    const avatar1 = this.getAvatar("avatars/1.jpg");
    const avatar2 = this.getAvatar("avatars/2.jpg");
    const avatar6 = this.getAvatar("avatars/8.jpg");
              ...
              <Row>
                <Col lg="6">
                  <Card className="main-card mb-3">
                    <ListGroup flush>
                      {this.renderProfileListItem(profile1, true, false)}
                      {this.renderProfileListItem(profile2, false, true)}
                      {this.renderProfileListItem(profile3, false, false)}
                      {this.renderProfileListItem(profile4, false, false)}
                      {this.renderProfileListItem(profile5, false, false)}
