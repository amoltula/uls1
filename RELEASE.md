...
## v4.3.0 - Configuration System Release
...
This release introduces a comprehensive configuration management system that externalizes all hardcoded values into environment variables, with full Docker support and multi-environment workflows.

**Key Features:**
- ✅ Centralized configuration in `src/config/constants.ts` (50+ variables)
- ✅ Environment file templates (.env.example, .env.development, .env.production)
- ✅ Docker integration with build args and env_file support
- ✅ Configuration validation (runtime and pre-flight)
- ✅ Comprehensive documentation (1,500+ lines)
- ✅ Testing infrastructure (57 passing tests, 80% coverage)
- ✅ Security enhancements (.gitignore updates, best practices)

**See [CONFIGURATION_SUMMARY.md](./CONFIGURATION_SUMMARY.md) for complete details.**

---

## v4.2.0 - Vite Migration & TypeScript

**Release Date:** December 3, 2025

This major release completes the modernization of ArchitectUI React with a full migration from Create React App to **Vite 7.2.6** and **TypeScript**, bringing dramatically faster build times and improved developer experience.
